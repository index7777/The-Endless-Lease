...
任何角色動畫工作開始前，必須先完整閱讀根目錄 `無期租寓_角色動畫製作最高規則_v1.0.md`。任何骰子動畫工作開始前，還必須完整閱讀根目錄 `無期租寓_骰子動畫製作最高規則_v1.0.md`。
...
3. 根目錄 `無期租寓_開發總交接文件_v2.0.md`
4. 根目錄 `無期租寓_待辦追蹤_v1.0.md`
5. `app/game.tsx`
6. `app/globals.css`
7. `.openai/hosting.json`
